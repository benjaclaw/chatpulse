        ...
        <div className="lg:sticky lg:top-8 max-w-full overflow-hidden">
          <div className="rounded-xl border bg-card p-4 shadow-sm">
            ...
            <div className="mb-3 rounded-lg border border-amber-300 bg-amber-50 px-3 py-2 text-xs text-amber-800 dark:border-amber-700 dark:bg-amber-950/40 dark:text-amber-300">
              {language === "nb"
                ? "Dette er en forhåndsvisning. Embed chatboten på nettsiden din for å se den i aksjon."
                : "This is a preview. Embed the chatbot on your website to see it in action."}
            </div>
            <ChatWidget
              inline
