...
const visitorRateLimiter = createRateLimiter(20); // 20 messages per minute per visitor
const chatbotRateLimiter = createRateLimiter(100); // 100 messages per minute per chatbot
